        ...
        <div className="container">
          ...
          <div className="story-grid">
            ...
            <div className="story-text" data-aos="fade-left">
              ...
              <p>Nossa história começou de forma única no dia 10 de agosto de 2025, quando o primeiro beijo marcou o início do nosso para sempre. Naquele instante, tivemos a certeza de que existia algo especial entre nós, algo raro, intenso e verdadeiro.</p>
